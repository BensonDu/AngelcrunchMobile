    ...
    function() {
        ...
        var a = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
            ...
            if (this._el = document.getElementById(b), null !== this._el) {
                this._radius = a.radius || 10, this._duration = void 0 === a.duration ? 500 : a.duration, this._value = 0, this._maxValue = a.maxValue || 100, this._maxTextValue = a.maxTextValue || this._maxValue, this._text = void 0 === a.text ?
                    function(a) {
        ...
        b.prototype = {
            ...
            _setPercentage: function(a) {
                this._movingPath.setAttribute("d", this._calculatePath(a, !0)), this._textContainer.innerHTML = this._getText(this.getTextValueFromPercent(a))
            },
            ...
            _getText: function(a) {
                return this._text ? (void 0 === a && (a = this._value), a = parseFloat(a.toFixed(0)), "function" == typeof this._text ? this._text.call(this, a) : this._text) : ""
            },
            ...
            updateMaxTextValue: function(a){
                return this._maxTextValue = a || this._maxValue;
            },
            getPercent: function() {
                return 100 * this._value / this._maxValue
            },
            getTextValueFromPercent: function(a){
                return this._maxTextValue * a / 100
            },
            ...
            setPercent: function(a){
                var p = a || 0;
                return this._value = p, this._setPercentage(p),this;
            },
            updateTo: function(b,c){
                var self = this, to = self._value = Math.min(self._maxValue,Math.max(0,b)), t = 1, s = 0, d = c || self._duration;
                return t = setInterval(function(){
                    var n = self.getPercent()* s / d;
                    s < d ? (self._setPercentage(n),s += 13) : (self._setPercentage(to),clearInterval(t));
                },13);
            },
            update: function(b, c) {
