...
(function(){
    ...
    avalon_attach_details()({
        avatar:'http://dn-xswe.qbox.me/100336450?imageMogr2/crop/!300x300a2a6/thumbnail/800x',
        name:'兰宁羽',
        company : '天使汇',
        title : 'CEO',
        summary :'天使汇创始人，曾创立一起音乐网、天下书盟等6家企业，带领团队开发了基于网络技术的海量数据检索、手机本地搜索和移动商务平台等项目。具有多年的天使投资经验，成功投资下厨房、V2EX、番茄土豆等企业。',
        invest_preference : {
            business : '北京 · 海淀',
            count : 20,
            min_amount :10,
        ...
        exp : [
            {
                logo : 'http://fs.angelcrunch.com/IMG/12828030',
                name : '翎客航天',
                part : '投资人'
            },
            {
                logo : 'http://fs.angelcrunch.com/IMG/12928861',
                name : '天使汇',
                part : '投资人'
            },
            {
                logo : 'http://fs.angelcrunch.com/IMG/100391665',
                name : 'TECH2IPO/创见',
                part : '投资人'
            },
            {
                logo : 'http://fs.angelcrunch.com/IMG/13056634',
                name : '大傻子',
                part : '投资人'
            }
        ],
        style : '每一个满足下列条件的人都值得投资： 1、靠谱，说到做到 2、热情，正能量 3、钻研精神 4、执着，有韧性和坚持力 5、执行力强 加分项： 创始人有技术背景·有可供验证的产品或服务·有成长潜力和广阔的市场空间·快速扩张能力·有独特资源·对行业深刻理解',
        services : [
            '正确的方针政策路线',
            '做创业者的119、110、112、114',
            '找关键人才',
            '持续不断的快速融资',
            '关键时刻的决策建议'
        ],
        business:
            'pivoting · 天使投资· 筛选力· 方向'
