(function(){
    log.type = 'login';
    this.api = {
        forget_mail:base_mobile+'v4/home/password_reset_email',
        /*verify:base_mobile+'v4/home/verify_code',*/
        verify:'http://api.angelcrunch.com/v1/rewrite/verify_code',
        forget_phone:base_mobile+'v4/home/password_reset_phone'
    }
...
(function(){
    ...
    $regist.attr('href','/account/regist'+(!!location.href.split('?')[1]?'?'+location.href.split('?')[1]:''));
}).call(this);
//百度统计
(function() {
    var _hmt = this._hmt || [],
